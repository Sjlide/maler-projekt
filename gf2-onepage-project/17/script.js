...
let inventory = document.getElementById("itemsPop")

function openInventory(){
  inventory.classList.add("Up-inventory")
  document.getElementById("plusInventory")
}

function closeInventory(){
  inventory.classList.remove("Up-inventory")
}
